...
export default function HeroSection() {
  ...
  const content = language === 'kk' ? {
    ...
    titleLine2: 'г. Тараз',
    description: 'Это учебное заведение образования г. Тараз, где детей обучают изобразительному искусству, развивают их творческие способности под руководством опытных педагогов и знакомят с основами мировой культуры.',
