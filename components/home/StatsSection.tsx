    ...
    <section className="py-12 md:py-16 bg-white relative overflow-hidden">
      ...
      <div className="section-container relative">
        ...
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-trustBlue mb-2">Біздің сандар</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Жылдар бойы жиналған тәжірибе және жетістіктер</p>
