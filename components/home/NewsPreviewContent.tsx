...
// Get the first image URL from blocks
...
export default function NewsPreviewContent({ articles }: NewsPreviewContentProps) {
      ...
      <div className="section-container">
        ...
        {articles.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-lg">{content.noNews}</p>
          </div>
        ) : (
